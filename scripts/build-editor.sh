#!/bin/bash
# Build script for FPSGame Editor using RunUAT
...
echo -e "${GREEN}Building FPSGame Editor using RunUAT...${NC}"
...
"$BUILD_SCRIPT" FPSGameEditor "$TARGET_PLATFORM" "$BUILD_TYPE" -Project="$PROJECT_FILE"
